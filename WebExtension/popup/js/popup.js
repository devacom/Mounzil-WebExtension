/*
* mdm-chrome-wrapper (forked from uget-chrome-wrapper ) is an extension to integrate PDM Download manager
...
$(document).ready(function () {
    ...
    BrowserNameSpace.runtime.getBackgroundPage( async (backgroundPage) => {
        ...
        dlInterruptCheckBox.prop('checked', config['mdm-interrupt']);
